							  ...
							  /*   if($i==0){
                                ...
                                checkAlreadyExists($prayerDate);
								 $query = "INSERT into salat_times(prayer_date,
									...
									isha_iqama ,
									shurooq ) 
									   values ('".$prayerDate."','".trim($getData[1])."','".trim($getData[2])."','".trim($getData[3])."','".trim($getData[4])."','".trim($getData[5])."','".trim($getData[6])."','".trim($getData[7])."','".trim($getData[8])."','".trim($getData[9])."','".trim($getData[10])."','".trim($getData[11])."','".trim($getData[12])."','".trim($getData[13])."','".trim($getData[14])."','".trim($getData[15])."','".trim($getData[16])."')";
