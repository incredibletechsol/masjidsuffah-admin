   ...
   <body>
      ...
      <script>
         $(document).ready(function () {
             ...
             $("#txtEditor").Editor("setText", "2750 Jiles Road,<br/>Kennesaw, GA 30144,<br/>Email: info@masjidsuffah.com<br> <img src='https://masjidsuffah.com/dev/masjidsuffah-admin/img/masjidlogo.png'/>")
         });
