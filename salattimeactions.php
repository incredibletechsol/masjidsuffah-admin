	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(!$_POST['isha_beginning']== '')
					...
					$isha_beginning = '0000-00-00 00:00:00';
				
				
				if(!$_POST['isha_athan']== '')
					$isha_athan = $_POST['isha_athan'];
				else
					$isha_athan = '0000-00-00 00:00:00';
								
				if(!$_POST['isha_iqama']== '')
					$isha_iqama = $_POST['isha_iqama'];
				else
					$isha_iqama = '0000-00-00 00:00:00';

				if(!$_POST['shurooq']== '')
					$shurooq = $_POST['shurooq'];
				else
					$shurooq = '0000-00-00 00:00:00';
